    ...
    data: [
      {
        ...
        description:
          "Stable corporate bonds with a fixed return. Ideal for conservative investors.",
      },
      {
        ...
        description:
          "Government-backed long-term bonds for low-risk investors.",
      },
      {
        ...
        description:
          "Bond issued by municipalities to fund infrastructure projects.",
      },
      {
      ...
      },
      {
        ...
        description:
          "Risky bonds offering very high returns for aggressive investors.",
      },
      {
      ...
      },
      {
        ...
        maxInvestment: 2000000,
        description:
          "Long-term FD with higher interest for moderate risk takers.",
      },
      {
      ...
      },
      {
        ...
        maxInvestment: 500000,
        description:
          "High-growth potential mutual fund in healthcare companies.",
      },
      {
      ...
      },
      {
        ...
        maxInvestment: 2000000,
        description:
          "ETF tracking global stock indices for diversified growth.",
      },
      {
      ...
      },
      {
        ...
        maxInvestment: 200000,
        description:
          "Diversified commodity investments including gold and oil.",
      },
      {
      ...
      },
      {
        ...
        maxInvestment: 2000000,
        description:
          "Fund targeting infrastructure and public utility projects.",
      },
      {
        ...
        maxInvestment: 100000,
        description:
          "Scheme allowing monthly gold accumulation with small investments.",
      },
      {
      ...
      },
      {
        ...
        description:
          "Real estate investment trust focused on healthcare facilities.",
      },
      {
        ...
        description:
          "Impact-driven fund supporting businesses with positive climate initiatives.",
      },
      {
