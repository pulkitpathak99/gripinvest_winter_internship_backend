...
export default function Chatbot() {
  ...
  const [messages, setMessages] = useState<{ role: 'user' | 'model'; parts: string }[]>([
    ...
    { role: 'model', parts: "Hello! I'm Finley, your AI Investment Analyst. How can I help you today?" }
  ]);
  ...
  const handleSend = async () => {
    ...
    try {
      ...
      const errorMessage = { role: 'model' as const, parts: "Sorry, I'm having trouble connecting right now. Please try again later." };
  ...
  return (
    ...
    >
      <header className="p-4 border-b border-slate-700 flex justify-between items-center flex-shrink-0">
        ...
        <button onClick={closeChat} className="text-gray-400 hover:text-white"><X size={20} /></button>
      </header>
