...
export default function ProductFormModal({
  ...
  const handleChange = (
    ...
    const isNumber = ["annualYield", "tenureMonths", "minInvestment"].includes(
      name,
    );
    setFormData((prev) => ({
      ...prev,
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                required
                className="mt-1 w-full p-2 bg-slate-800 border border-slate-700 rounded-lg"
              />
            </div>
            <div>
              <label className="block text-sm font-medium text-gray-400">
          ...
          <div className="pt-4 flex justify-end gap-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="px-6 py-2 bg-blue-600 text-white rounded-lg font-semibold hover:bg-blue-700 disabled:bg-slate-700"
            >
