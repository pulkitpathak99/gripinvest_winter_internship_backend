                ...
                <header className="bg-slate-950/50 backdrop-blur-sm border-b border-slate-800 p-4 flex items-center justify-between">
                   ...
                   <div className="flex items-center gap-4">
                        <div className="relative">
                            ...
                            <input type="text" placeholder="Search..." className="bg-slate-800 border border-slate-700 rounded-lg pl-10 pr-4 py-2 text-sm w-48 focus:outline-none focus:ring-2 focus:ring-blue-500" />
                        </div>
