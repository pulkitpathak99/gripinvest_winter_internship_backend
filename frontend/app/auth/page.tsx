      ...
      <div className="w-full max-w-4xl mx-auto grid md:grid-cols-2 shadow-2xl rounded-2xl overflow-hidden">
        ...
        <div className="p-12 bg-slate-950/50 hidden md:flex flex-col justify-center items-center text-center">
          ...
          <p className="text-gray-400">
            Your journey to intelligent investing starts here. Secure,
        ...
        <div className="p-8 md:p-12 bg-slate-900">
          <div className="flex mb-6 border-b border-slate-800">
            <button
              ...
              className={clsx(
                "w-1/2 py-3 font-semibold text-center transition-colors",
                isLoginMode
          ...
          >
                ...
                >
                  <div>
                    ...
                    <input
                      ...
                      required
                      className="w-full mt-1 p-3 bg-slate-800 border border-slate-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                    />
                  </div>
                  <div>
                    <label className="text-sm font-medium text-gray-400">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full flex justify-center items-center gap-2 p-3 font-semibold text-white bg-blue-600 rounded-lg hover:bg-blue-700 disabled:bg-slate-700 transition-colors"
            >
            ...
            {isLoginMode && (
              <Link
                ...
                className="block text-center text-sm text-blue-400 hover:underline mt-4"
              >
                Forgot Password?
              </Link>
            )}
